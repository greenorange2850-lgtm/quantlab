...
import { AlertCircle, Brain, FlaskConical, RefreshCw, SlidersHorizontal } from 'lucide-react'
      ...
      <div className="mx-auto w-full max-w-6xl min-w-0 space-y-4">
        ...
        <Card hover={false} className="border-dashed">
          <CardContent className="flex flex-col gap-3 py-8 text-center">
            <p className="text-sm font-medium">No research session available</p>
            <p className="mx-auto max-w-md text-pretty text-xs text-muted-foreground">
              Run Random Search in the Optimizer to generate a ResearchReport. This page visualizes
              archived results only — it does not run new analytics.
            </p>
    ...
    <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="text-pretty text-xs text-muted-foreground">
            Historical research workspace — read-only visualization of archived ResearchReport data.
          </p>
          {sessionId ? (
